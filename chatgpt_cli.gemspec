...
Gem::Specification.new do |spec|
  ...
  spec.metadata['source_code_uri'] = 'https://github.com/yocajii/chatgpt-cli'
  spec.metadata['changelog_uri'] = 'https://github.com/yocajii/chatgpt-cli/blob/main/CHANGELOG.md'
